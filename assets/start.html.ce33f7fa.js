import{_ as i,r as o,o as c,c as r,a as s,d as a,w as t,b as n,e as u}from"./app.50ec1cdd.js";const l={},d=s("h1",{id:"novice-guide",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#novice-guide","aria-hidden":"true"},"#"),n(" Novice Guide")],-1),v=u(`<h2 id="server" tabindex="-1"><a class="header-anchor" href="#server" aria-hidden="true">#</a> server</h2><p>You need a server outside the firewall to run V2Ray on the server side. The configuration is as follows:</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
